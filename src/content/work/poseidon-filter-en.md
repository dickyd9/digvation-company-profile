...
approach: We shaped the Home, About, Product, and Contact journeys, simplified categories, and moved inquiry closer to product context.
solution: A responsive website that brings Poseidon's brand, product discovery, and inquiry into one place.
built:
  - Responsive marketing website
  - Brand and product structure
  - Water-filtration category discovery
  - Inquiry path to sales
